...
const translations: { [key: string]: string } = {
  ...
  // Navigation
  'nav.chat': 'Trò chuyện',
  'nav.documents': 'Dữ liệu',
  'nav.schools': 'Trường học của tôi',
  'nav.provinces': 'Tỉnh thành',
  'nav.userManagement': 'Quản lý người dùng',
  'nav.systemTree': 'Cây hệ thống',
  'nav.documentStore': 'Kho dữ liệu',
  
  // Chat
  'chat.newChat': 'Cuộc trò chuyện mới',
  'chat.chatHistory': 'Lịch sử trò chuyện',
  'chat.messages': 'tin nhắn',
  'chat.askQuestion': 'Đặt câu hỏi về dữ liệu của bạn...',
  'chat.aiCanMakeMistakes': 'AI có thể mắc lỗi. Hãy xác minh thông tin quan trọng từ dữ liệu của bạn.',
  'chat.hello': 'Xin chào! Tôi là trợ lý AI của bạn. Tôi có thể giúp bạn tìm thông tin từ các dữ liệu đã tải lên. Bạn muốn biết gì?',
  'chat.referencedDocuments': 'Dữ liệu tham khảo:',
  
  // Documents
  'documents.manager': 'Quản lý dữ liệu',
  'documents.uploadAndManage': 'Tải lên và quản lý dữ liệu cho Q&A được hỗ trợ bởi AI',
  'documents.uploadDocuments': 'Tải lên dữ liệu',
  'documents.manageDocuments': 'Quản lý dữ liệu',
  'documents.dropFiles': 'Thả tệp vào đây hoặc nhấp để duyệt',
  'documents.supportedFormats': 'Hỗ trợ dữ liệu Word (.doc, .docx), và tệp Excel (.xls, .xlsx)',
  'documents.chooseFiles': 'Chọn tệp',
  'documents.uploading': 'Đang tải lên...',
  'documents.recentUploads': 'Tải lên gần đây',
  'documents.searchDocuments': 'Tìm kiếm dữ liệu...',
  'documents.allStatus': 'Tất cả trạng thái',
  'documents.ready': 'Sẵn sàng',
  'documents.processing': 'Đang xử lý',
  'documents.error': 'Lỗi',
  'documents.noDocuments': 'Không tìm thấy dữ liệu',
  'documents.tryAdjusting': 'Thử điều chỉnh tiêu chí tìm kiếm hoặc bộ lọc',
  'documents.uploadFirst': 'Tải lên dữ liệu đầu tiên để bắt đầu',
  'documents.tips': 'Mẹo để có kết quả tốt hơn:',
  'documents.tip1': '• Tải lên dữ liệu rõ ràng, dễ đọc để xử lý AI tối ưu',
  'documents.tip2': '• Sắp xếp tệp với tên mô tả',
  'documents.tip3': '• Dữ liệu trải qua xử lý nâng cao: trích xuất văn bản, lập chỉ mục và tối ưu hóa AI',
  'documents.tip4': '• Sử dụng tính năng trò chuyện để đặt câu hỏi về nội dung đã tải lên',
  'documents.tip5': '• Dữ liệu lớn hơn có thể mất nhiều thời gian xử lý nhưng cung cấp kết quả toàn diện hơn',
  ...
  'schools.note2': '• Trường học có thể tải lên dữ liệu và sử dụng tính năng trò chuyện AI',
  ...
  'provinces.provinceNote3': '• Họ có thể giám sát tất cả hoạt động của trường học và tải lên dữ liệu',
  ...
  // Document Store
  'documentStore.title': 'Kho dữ liệu',
  'documentStore.subtitle': 'Quản lý dữ liệu tập trung cho tất cả người dùng hệ thống',
  'documentStore.searchDocuments': 'Tìm kiếm dữ liệu theo tên hoặc chủ sở hữu...',
  'documentStore.allTypes': 'Tất cả loại',
  'documentStore.pdf': 'Dữ liệu',
  'documentStore.word': 'Word',
  'documentStore.excel': 'Excel',
  'documentStore.document': 'Dữ liệu',
  'documentStore.deputyDocs': 'Dữ liệu phó giám đốc',
  'documentStore.provinceDocs': 'Dữ liệu tỉnh',
  'documentStore.schoolDocs': 'Dữ liệu trường học',
  'documentStore.totalSize': 'Tổng dung lượng',
  
  // Additional translations
  'documents.enterTitle': 'Nhập tiêu đề dữ liệu',
  'documents.enterDescription': 'Nhập mô tả dữ liệu',
  ...
  // Document Management
  'documents.uploadDocument': 'Tải lên dữ liệu',
  'documents.uploadStaffDocument': 'Tải lên dữ liệu nhân viên',
  'documents.uploadStudentsDocument': 'Tải lên dữ liệu học sinh',
  'documents.uploadExaminationsDocument': 'Tải lên dữ liệu thi cử',
  'documents.exampleDocuments': 'Dữ liệu mẫu',
  'documents.exampleDescription': 'Tải xuống các mẫu Excel để xem định dạng yêu cầu cho từng loại dữ liệu.',
  ...
  'documents.deleteConfirm': 'Bạn có chắc chắn muốn xóa dữ liệu này?',
  'documents.noDocumentsFound': 'Không tìm thấy dữ liệu',
  'documents.tryAdjustingSearch': 'Thử điều chỉnh tiêu chí tìm kiếm hoặc lọc',
  'documents.uploadFirstDocument': 'Tải lên dữ liệu đầu tiên để bắt đầu',
};
